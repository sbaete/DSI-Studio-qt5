...
public:
    ...
    void retranslateUi(QDialog *vbc_dialog)
    {
        ...
        save_name_list->setText(QApplication::translate("vbc_dialog", "Save name list...", 0));
        label_13->setText(QApplication::translate("vbc_dialog", "Zoom", 0));
        ...
        ___qtablewidgetitem1->setText(QApplication::translate("vbc_dialog", "Value", 0));
        QTableWidgetItem *___qtablewidgetitem2 = subject_list->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("vbc_dialog", "R2", 0));
        toolBox->setItemText(toolBox->indexOf(page), QApplication::translate("vbc_dialog", "Source Data", 0));
        groupBox_4->setTitle(QApplication::translate("vbc_dialog", "Model", 0));
        rb_multiple_regression->setText(QApplication::translate("vbc_dialog", "Multiple Regression: (e.g. to study connectivity change due to aging or IQ difference)", 0));
        rb_group_difference->setText(QApplication::translate("vbc_dialog", "Group difference (e.g. to study connectivity difference between male and female)", 0));
        rb_paired_difference->setText(QApplication::translate("vbc_dialog", "Paired difference (e.g. to study connectivity difference before and after a treatment)", 0));
        rb_individual_analysis->setText(QApplication::translate("vbc_dialog", "Individual Analysis (e.g. to study the affected pathways of each stroke patient)", 0));
        percentile_rank_group->setTitle(QString());
        label_5->setText(QApplication::translate("vbc_dialog", "p-value or percentile threshold", 0));
        label_8->setText(QApplication::translate("vbc_dialog", "0.05: week difference   0.01: moderate difference   0.002: strong difference", 0));
        advanced_options->setText(QApplication::translate("vbc_dialog", "Advanced options...", 0));
        advanced_options_box->setTitle(QString());
        label_4->setText(QApplication::translate("vbc_dialog", "Permutation Count", 0));
        label_3->setText(QApplication::translate("vbc_dialog", "Length Threshold (mm)", 0));
        label_7->setText(QApplication::translate("vbc_dialog", "Track Pruning (iterations)", 0));
        toolBox->setItemText(toolBox->indexOf(page_2), QApplication::translate("vbc_dialog", "STEP1: Select analysis model", 0));
        individual_demo->setTitle(QString());
        open_files->setText(QApplication::translate("vbc_dialog", "...", 0));
        open_instruction->setText(QApplication::translate("vbc_dialog", "Open subjects' fib files ", 0));
        ...
        label_6->setText(QApplication::translate("vbc_dialog", "Please choose a feature to study:", 0));
        QTableWidgetItem *___qtablewidgetitem3 = subject_demo->horizontalHeaderItem(0);
        ___qtablewidgetitem3->setText(QApplication::translate("vbc_dialog", "Subject ID", 0));
        toolBox->setItemText(toolBox->indexOf(page_4), QApplication::translate("vbc_dialog", "STEP2: Provide demographics", 0));
        ...
        show_lesser_2->setText(QApplication::translate("vbc_dialog", "FDR lesser", 0));
        show_greater_2->setText(QApplication::translate("vbc_dialog", "FDR greater", 0));
        label->setText(QApplication::translate("vbc_dialog", "max x:", 0));
        ...
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_3), QApplication::translate("vbc_dialog", "Report", 0));
        label_2->setText(QApplication::translate("vbc_dialog", "multi-thread", 0));
        run->setText(QApplication::translate("vbc_dialog", "Run", 0));
        toolBox->setItemText(toolBox->indexOf(page_3), QApplication::translate("vbc_dialog", "STEP3: Run connectometry analysis", 0));
    } // retranslateUi
